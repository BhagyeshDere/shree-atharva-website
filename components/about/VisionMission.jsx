...
export default function VisionMission() {
  return (
    <section className="relative pt-24 pb-16 md:pt-40 md:pb-24 bg-[#050a1a] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-stretch">
          ...
          >
            ...
            <div className="relative h-full bg-white/5 backdrop-blur-xl border border-white/10 p-10 md:p-14 lg:p-16 rounded-[60px_10px_60px_10px] overflow-hidden transition-all duration-500 hover:border-[#DA1F28]/50">
              ...
              <div className="relative z-10">
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-[#DA1F28] flex items-center justify-center shadow-[0_0_30px_rgba(218,31,40,0.4)] mb-8 md:mb-10 rotate-3 group-hover:rotate-0 transition-transform duration-500">
                ...
                <p className="mt-6 md:mt-8 text-slate-400 text-lg md:text-xl leading-8 md:leading-9 font-medium">
          ...
          >
            ...
            <div className="relative h-full bg-white/5 backdrop-blur-xl border border-white/10 p-10 md:p-14 lg:p-16 rounded-[10px_60px_10px_60px] overflow-hidden transition-all duration-500 hover:border-[#1A52A2]/50">
               {/* Floating Decorative A */}
               <div className="absolute -top-10 -right-10 text-white/[0.02] text-[15rem] font-black italic select-none">A</div>

              <div className="relative z-10">
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-[#1A52A2] flex items-center justify-center shadow-[0_0_30px_rgba(26,82,162,0.4)] mb-8 md:mb-10 -rotate-3 group-hover:rotate-0 transition-transform duration-500">
