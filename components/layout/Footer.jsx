...
export default function Footer() {
  // SVG Social Icons for guaranteed build stability
  const socials = [
    {
      name: "Facebook",
      href: "#",
  ...
  return (
    <footer className="relative bg-[#050a1a] text-white pt-20 overflow-hidden">
      {/* Decorative Brand Accent - Top Border */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Home", "About Us", "Services", "Products", "Projects", "Contact"].map((item) => (
          ...
          <div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-3 items-center">
                ...
                <p className="text-slate-400 text-sm">+91 9422504471</p>
              </div>
              <div className="flex gap-3 items-center">
                <Mail className="w-5 h-5 text-[#DA1F28] shrink-0" />
                <p className="text-slate-400 text-sm">atharvaent101@gmail.com</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-3 items-center">
                <Phone className="w-5 h-5 text-[#DA1F28] shrink-0" />
                <p className="text-slate-400 text-sm">+91 8484003636</p>
              </div>
              <div className="flex gap-3 items-center">
                <Mail className="w-5 h-5 text-[#DA1F28] shrink-0" />
                <p className="text-slate-400 text-sm">atharvaent101@gmail.com</p>
      ...
      <div className="border-t border-white/5 bg-black/30 backdrop-blur-sm py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          <p className="text-slate-500 text-[10px] font-medium uppercase tracking-widest">
            © 2026 Shree Atharva Enterprises. All Rights Reserved.
          </p>
          <div className="flex flex-col md:flex-row items-center gap-1">
             <p className="text-slate-500 text-[10px] font-medium uppercase tracking-widest">
               Developed by
             </p>
             <span className="text-white font-bold text-[10px] uppercase tracking-widest hover:text-[#DA1F28] cursor-pointer transition-colors">
